 ...
 */
public class YSwitch extends YCompoundButton {
    ...
    public YSwitch(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        mTrackDrawable = a.getDrawable(Styleable.getKey("Switch_track"));
        if (mTrackDrawable != null) {
            mTrackDrawable.setCallback(this);
        }
        mTextOn = a.getText(Styleable.getKey("Switch_textOn"));
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (mThumbDrawable != null) {
            final Insets inset = DrawableUtils.getOpticalInsets(mThumbDrawable);
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        if (mThumbDrawable != null) {
            ...
            final Insets insets = DrawableUtils.getOpticalInsets(mThumbDrawable);
    ...
    public void draw(Canvas c) {
        ...
        if (mThumbDrawable != null) {
            thumbInsets = DrawableUtils.getOpticalInsets(mThumbDrawable);
        } else {
    ...
    private int getThumbScrollRange() {
        if (mTrackDrawable != null) {
            ...
            final Insets insets;
            if (mThumbDrawable != null) {
                insets = DrawableUtils.getOpticalInsets(mThumbDrawable);
            } else {
                insets = Insets.NONE;
            }
    ...
    public void onInitializeAccessibilityEvent(AccessibilityEvent event) {
        ...
        event.setClassName(YSwitch.class.getName());
    }
