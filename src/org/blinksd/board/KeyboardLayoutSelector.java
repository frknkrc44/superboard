...
public class KeyboardLayoutSelector extends Activity implements View.OnClickListener {
    ...
    protected void onPostCreate(Bundle savedInstanceState) {
        ...
        Map<String, LayoutUtils.Language> languageList = SuperBoardApplication.getKeyboardLanguageList();
    ...
    private View createItemLayout(LayoutUtils.Language language) {
        ...
        if (language.midPadding && language.layout != null) {
            preview.setRowPadding(0, language.layout.size() / 2, DensityUtils.wpInt(2));
        }
        ...
        description.setText(language.label);
    ...
    public void onClick(View v) {
        SuperBoardApplication.getApplicationDatabase()
                .putString(SettingMap.SET_KEYBOARD_LANG_SELECT,
                        (String) ((View) v.getParent()).getTag());
